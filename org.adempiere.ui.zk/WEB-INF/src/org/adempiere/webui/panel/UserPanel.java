...
public class UserPanel implements EventListener<Event>, Composer<Component>
{
    ...
    protected void onCreate()
    {
    	...
    	*/
    	...
    	user = (ToolBarButton) component.getFellowIfAny("user", true);
		user.setTooltiptext(Msg.getMsg(Env.getCtx(), "User") + " : " + getUserName());
		user.setIconSclass("z-icon-user");
		user.addEventListener(Events.ON_CLICK, this);

    	feedback = (LabelImageElement) component.getFellowIfAny("feedback", true);
    	feedback.setTooltiptext(Msg.getMsg(Env.getCtx(), "Feedback"));
    	feedback.setIconSclass("z-icon-comments-o");
    	feedback.addEventListener(Events.ON_CLICK, this);

    	preference = (ToolBarButton) component.getFellowIfAny("preference", true);
		preference.setTooltiptext(Msg.getMsg(Env.getCtx(), "Preference"));
		preference.setIconSclass("z-icon-star");
		preference.addEventListener(Events.ON_CLICK, this);

		changeRole = (ToolBarButton) component.getFellowIfAny("changeRole", true);
		changeRole.setTooltiptext(Msg.getMsg(Env.getCtx(), "changeRole"));
		changeRole.setIconSclass("z-icon-random");
		changeRole.addEventListener(Events.ON_CLICK, this);

		logout = (ToolBarButton) component.getFellowIfAny("logout", true);
		logout.setTooltiptext(Msg.getMsg(Env.getCtx(), "Logout"));
