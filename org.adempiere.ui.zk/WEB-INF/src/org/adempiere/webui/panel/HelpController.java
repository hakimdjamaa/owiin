...
{	
	...
	public void render(Component parent, IDesktop desktopImpl)
    {
		...
		dashboardColumn.setAnchor("100% 100%");
        ...
        Caption caption = new Caption(Msg.getMsg(Env.getCtx(), "QuickInfo"));
        caption.setSclass("panel-caption");
        caption.setIconSclass("z-icon-star");
        pnlQuickInfo.appendChild(caption);
        pnlQuickInfo.setMaximizable(false);
        pnlQuickInfo.setCollapsible(false);
        ...
        Caption captionToolTip = new Caption(Msg.getMsg(Env.getCtx(), "ToolTip"));
        captionToolTip.setSclass("panel-caption");
        captionToolTip.setIconSclass("z-icon-exclamation");
        pnlToolTip.appendChild(captionToolTip);
    	pnlToolTip.setMaximizable(false);
    	pnlToolTip.setCollapsible(false);
        ...
        Caption captionContextHelp = new Caption(Msg.getMsg(Env.getCtx(), "HowTo"));
        captionContextHelp.setSclass("panel-caption");
        captionContextHelp.setIconSclass("z-icon-rocket");
        pnlContextHelp.appendChild(captionContextHelp);
        pnlContextHelp.setMaximizable(false);
        pnlContextHelp.setCollapsible(false);
    ...
    public void renderCtxHelp(String ctxType, int recordId)
    {
    	...
    	pnlContextHelp.getCaption().setLabel(ctxType.equals(X_AD_CtxHelp.CTXTYPE_Home) ? Msg.getMsg(Env.getCtx(), "GettingStarted") : Msg.getMsg(Env.getCtx(), "HowTo"));
    	
    	pnlContextHelp.getCaption().setIconSclass(ctxType.equals(X_AD_CtxHelp.CTXTYPE_Home) ? "z-icon-rocket" : "z-icon-question");
